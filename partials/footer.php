        ...
        <div class="grid grid-cols-1 md:grid-cols-12 gap-10">
          ...
          <div class="md:col-span-4">
            ...
            <p class="text-sm text-gray-300">
              Siap menskalakan bisnis IT Anda? <a href="mailto:<?php echo $c['email']; ?>" class="text-white font-semibold underline underline-offset-2 hover:text-brand-100 transition-colors">Konsultasi Gratis &rarr;</a>
            </p>
          </div>
          ...
          <div class="md:col-span-4">
            ...
            <div class="flex items-center space-x-5 mt-6">
              <a href="<?php echo $c['instagram']; ?>" class="text-gray-400 hover:text-white transition-colors duration-200" target="_blank" rel="noopener" aria-label="Instagram">
